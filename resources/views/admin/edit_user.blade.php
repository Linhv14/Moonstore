    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card shadow h-100 py-2">
                <div class="card-body">
                    <form action="{{route('route.admin.update_user',['id' => $data->id])}}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city" placeholder="Vui lòng nhập thành phố"
                                value="{{old('city',$data->city)}}">
                        </div>
                        <div class="form-group">
                            <label>Quốc tịch</label>
                            <input type="text" class="form-control" name="country" placeholder="Vui lòng nhập quốc tịch"
