    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card shadow h-100 py-2">
                <div class="card-body">
                    <form action="{{route('route.admin.update_product',['id' => $data->id])}}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <img class="mt-3" src="{{asset('image/product/'.$data->image)}}" alt="" width="100px"
                                height="100px">
                        </div>
