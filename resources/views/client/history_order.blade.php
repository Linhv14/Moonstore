...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-9" id="content">   
            ...
            <h1>Đơn hàng {{$i+1}}</h1>
            <p>Thời gian đặt hàng: {{\Carbon\Carbon::parse($bills[$i]->created_at)->format('H:i d/m/Y ')}}</p>
            <p>Thời gian nhận hàng: {{\Carbon\Carbon::parse($bills[$i]->time_receive)->format('H:i d/m/Y ')}}</p>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right">{{$bills[$i]->address}}</td>
