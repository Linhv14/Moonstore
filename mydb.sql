...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1323627025ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=bill">`mydb`.`bill`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=orders">`mydb`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=users">`mydb`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=category">`mydb`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=slider">`mydb`.`slider`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=product">`mydb`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=post">`mydb`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=banner">`mydb`.`banner`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mydb&table=catagory">`mydb`.`catagory`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="67432955773b63716778387b416b3357">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mydb" targettable="bill">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `bill`</span>
                        </div>
